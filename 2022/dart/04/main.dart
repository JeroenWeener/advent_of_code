...
void main() {
  List<String> input = File('2022/dart/04/input.txt').readAsLinesSync();
...
int part1(List<String> input) {
  return input.map((element) {
    List<int> numbers =
        element.split(RegExp(r'[,-]')).map((e) => int.parse(e)).toList();
    ...
    // If the left bound is identical, there is always a containment.
    return true;
...
int part2(List<String> input) {
  return input.map((element) {
    ...
    // Check whether there is no overlap and inverse.
