...
void main() {
  final String input = File('2015/dart/03/input.txt').readAsStringSync();
...
int part1(String input) {
  ...
  for (final direction in input.codeUnits) {
    if (direction == '^'.codeUnits.first) {
      santaY++;
    } else if (direction == '>'.codeUnits.first) {
      santaX++;
    } else if (direction == '<'.codeUnits.first) {
      santaX--;
    } else {
...
int part2(String input) {
  ...
  santaLocations.addAll(roboLocations);

  return santaLocations.length;
}
