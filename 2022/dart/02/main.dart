...
void main() {
  List<String> input = File('2022/dart/02/input.txt').readAsLinesSync();
...
/// otal score be if everything goes exactly according to your strategy guide?
